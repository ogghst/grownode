...
//parameters
const char *GN_DS18B20_PARAM_UPDATE_TIME_SEC = "update_time_sec"; /*!< seconds between sensor sampling */
const char *GN_DS18B20_PARAM_GPIO = "gpio"; /*!< GPIO connected to the temp sensor */
