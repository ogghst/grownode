...
Boards are a collection of preconfigured Leaves to have a ready made solution, described in [Boards](/grownode/boards) section. Goal is to give you a working solution without the need of develop your own code.
